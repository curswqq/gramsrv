...
export const api = {
  ...
  reviewModerationAppeal: (caseID: number, appealID: number, payload: Record<string, unknown>) =>
	...
	auctionBids: (id: string) => request<StarGiftAuctionBidsResponse>(`/api/star-gift-auctions/${encodeURIComponent(id)}/bids`),
	...
	cancelAuctionBid: (payload: Record<string, unknown>) => request<CommandResult>("/api/actions/cancel-star-gift-auction-bid", { method: "POST", body: JSON.stringify(payload) }),
