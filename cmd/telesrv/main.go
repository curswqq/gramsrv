...
func run(logger *zap.Logger) error {
	...
	filesService := filesapp.NewService(mediaStore, blobBackend, cfg.DC,
		...
		filesapp.WithUploadMaxFileBytes(cfg.UploadMaxFileBytes),
	...
	adminService := adminapp.NewService(adminapp.Dependencies{
		...
		AccountFreezeBadgeIconDocumentID: cfg.AccountFreezeBadgeIconDocumentID,
	})
	...
	router := rpc.New(rpc.Config{
		...
		DevStarsPurchaseBlocked:     !cfg.DevStarsPurchaseEnabled,
		AccountFreezeBadgeBotUserID: cfg.AccountFreezeBadgeBotUserID,
