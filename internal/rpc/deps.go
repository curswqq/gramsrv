...
type AccountBusinessAutomationService interface {
	...
	UpdateSponsoredMessages(ctx context.Context, userID int64, enabled bool) (domain.BusinessProfile, error)
	...
	ReplaceQuickReplyMessage(ctx context.Context, userID int64, shortcutID, messageID int, msg domain.QuickReplyMessage) (domain.QuickReplyMutation, error)
	...
	GetConnectedBusinessBotByConnectionID(ctx context.Context, connectionID string) (domain.ConnectedBusinessBot, bool, error)
